...
document.write('<tr style="font:bold 13px Arial" onselectstart="return false"><td style="cursor:pointer;font-size:15px" onclick="upmonth(-1)" title="предыдущий месяц">&laquo;</td><td colspan="5" id="mns" align="center"></td><td align="right" style="cursor:pointer;font-size:15px" onclick="upmonth(1)" title="следующий месяц">&raquo;</td></tr>');
...
function lcs(ielem) {
	...
	getObj('fc').style.width=(ielem.offsetWidth>200?ielem.offsetWidth:200)+'px';
...
function cs_click(e) {
	...
	save_filter_data(updobj.getAttribute('name'), updobj.value);
	getObj('fc').style.display='none';
}
...
function prepcalendar(hd,cm,cy) {
	...
	getObj('mns').innerHTML='<span title="текущий месяц">'+mn[cm]+'</span>&nbsp;<span style="cursor:pointer" onclick="upmonth(-12)" title="на год назад">&lt;&lt;&nbsp;</span>'+cy+'<span style="cursor:pointer" onclick="upmonth(12)" title="на год вперед">&nbsp;&gt;&gt;</span>';
	marr=((cy%4)==0)?mnl:mnn;
	for(var d=1;d<=42;d++) {
